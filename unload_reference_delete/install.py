# -*- coding: utf-8 -*-
"""Unload Reference Delete — Maya へのインストーラ（ドラッグ&ドロップ）。
...
_REPO_SUBDIR = "unload_reference_delete"

_MODULE = "unload_reference_delete"  # パッケージ名（= フォルダ名）
...
_SHELF_BUTTON_LABEL = "UnldRefDel"      # シェルフに出す短い名前（10 文字以内）
