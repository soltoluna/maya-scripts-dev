...
|---|---|---|---|---|---|
| [color_override](color_override/) | Utility | 1.0.0 | 2024+ | シェルフ `ColorOvr` | 選択物を任意の色でフラットに塗り分け、同系色のオブジェクトの貫通をビューポートで見分ける。v1.0.0 からレンダーセットアップのマテリアルオーバーライドで掛けるので**元の割り当てを触らない**（**v1.0.0 は実機未確認**） |
